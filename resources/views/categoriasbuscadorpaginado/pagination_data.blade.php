...
<div>
        ...
        <div>
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-nombre="{{$row->nombre}}"  data-titulo="{{$row->id}}" >
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
        ...
        <form id="formulario" name="tuformulario" action="{{route('deletecategoria')}}" method="POST">
      @csrf
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="formulario" action="{{route('updatecategoria')}}" method="POST">
      @csrf
